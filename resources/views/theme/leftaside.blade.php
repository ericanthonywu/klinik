...
<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark ">
    ...
    <div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="0" m-menu-dropdown-timeout="500">
        <ul class="m-menu__nav ">
            ...
            <li class="m-menu__item  @if(Request::url() === url('/home')) m-menu__item--active @endif" aria-haspopup="true"><a href="{{url('/home')}}" class="m-menu__link "><span class="m-menu__item-here"></span><i class="m-menu__link-icon flaticon-line-graph"></i><span class="m-menu__link-text">Dashboard</span></a></li>
            <li class="m-menu__item   m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><span class="m-menu__item-here"></span><i class="m-menu__link-icon flaticon-layers"></i><span
                ...
                <div class="m-menu__submenu "><span class="m-menu__arrow"></span>
                    <ul class="m-menu__subnav">
                        <li class="m-menu__item  m-menu__item--parent" aria-haspopup="true"><span class="m-menu__link"><span class="m-menu__item-here"></span><span class="m-menu__link-text">Laporan</span></span></li>
                        <li class="m-menu__item @if(Request::url() === url('/pengeluaran')) m-menu__item--active @endif" aria-haspopup="true"><a href="{{url('/dokter')}}" class="m-menu__link "><i class="m-menu__link-bullet flaticon-user"><span></span></i><span class="m-menu__link-text">Pengeluaran</span></a></li>
                        <li class="m-menu__item @if(Request::url() === url('/pemasukkan')) m-menu__item--active @endif" aria-haspopup="true" m-menu-link-redirect="1"><a href="{{url('/user')}}" class="m-menu__link "><i class="m-menu__link-bullet flaticon-users"><span></span></i><span class="m-menu__link-text">Pemasukan</span></a></li>
                    </ul>
                </div>
            </li>
            <li class="m-menu__item @if(Request::url() === url('/dokter')) m-menu__item--active @endif" aria-haspopup="true" m-menu-link-redirect="1"><a href="{{url('/dokter')}}" class="m-menu__link "><span class="m-menu__item-here"></span><i class="m-menu__link-icon flaticon-suitcase"></i><span class="m-menu__link-text">Dokter</span></a></li>
            <li class="m-menu__item @if(Request::url() === url('/user')) m-menu__item--active @endif" aria-haspopup="true" m-menu-link-redirect="1"><a href="{{url('/user')}}" class="m-menu__link "><span class="m-menu__item-here"></span><i class="m-menu__link-icon flaticon-users"></i><span class="m-menu__link-text">User</span></a></li>
            <li class="m-menu__item @if(Request::url() === url('/obat')) m-menu__item--active @endif" aria-haspopup="true" m-menu-link-redirect="1"><a href="{{url('/obat')}}" class="m-menu__link "><span class="m-menu__item-here"></span><i class="m-menu__link-icon flaticon-"></i><span class="m-menu__link-text">Obat</span></a></li>
            <li class="m-menu__item @if(Request::url() === url('/stok')) m-menu__item--active @endif" aria-haspopup="true" m-menu-link-redirect="1"><a href="{{url('/obat')}}" class="m-menu__link "><span class="m-menu__item-here"></span><i class="m-menu__link-icon flaticon-list"></i><span class="m-menu__link-text">Stok</span></a></li>
