var DatatablesDataSourceAjaxClient = {
    init: function () {
        $("#m_table_1").DataTable({
            ...
            columns: [{data: "RecordID"}, {data: "OrderID"}, {data: "Country"}, {data: "ShipCity"}, {data: "ShipAddress"}, {data: "CompanyAgent"}, {data: "CompanyName"}, {data: "ShipDate"}, {data: "Status"}, {data: "Type"}, {data: "Actions"}],
            columnDefs: [{
